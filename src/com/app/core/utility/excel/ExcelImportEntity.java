...
public class ExcelImportEntity {
	...
	public String getImportCellType() {
		return importCellType;
	}

	public void setImportCellType(String importCellType) {
		this.importCellType = importCellType;
	}
